  ...
  return (
    <div>
      <div className="Med-loc">
          ...
          <li className="Medical-Store">
            ...
            <h2 className="MS-name">
              ...
              <span className="Rattings">
                <img src={assets.star} alt="" className="StarRatting" />
                3.5
              </span>
            </h2>
            <div className="MS-Location">
              RTC Bus Stant<span className="Time">16Mins</span>
            </div>
          </li>
          <li className="Medical-Store">
            ...
            <div className="MS-Location">
              Gandhi Bomma Center<span className="Time">25Mins</span>
            </div>
          </li>
          <li className="Medical-Store">
            ...
            <div className="MS-Location">
              Buja Buja Nellore<span className="Time">39Mins</span>
            </div>
          </li>
          <li className="Medical-Store">
            ...
            <div className="MS-Location">
              Chinna Bazar<span className="Time">10Mins</span>
            </div>
          </li>
          <li className="Medical-Store">
            <img src={assets.medstore5} alt="" className="MSImage" />
            <h2 className="MS-name">
              Venkateswara Medical
              <span className="Rattings">
                <img src={assets.star} alt="" className="StarRatting" />
                3.8
              </span>
            ...
            <div className="MS-Location">
              Kondaiah Palem Gate<span className="Time">24Mins</span>
            </div>
          </li>
          <li className="Medical-Store">
            <img src={assets.medstore5} alt="" className="MSImage" />
        ...
        <a href="/MedicalStoresPage">See More</a>
    </div>
  );
};
